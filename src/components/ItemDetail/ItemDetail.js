        ...
        <div className='container'>
            <div className='row justify-content-center mt-4'>
                <div className='col-4 text-center'>
                    <Link to='/cervezas' className="m-a-detail" aria-current="page">Cervezas</Link>
                </div>
            </div>
                ...
                <div className='col-12 col-sm-12 col-md-7 col-lg-7'>
                    <div className='row-cols-1'>
                        ...
                        <div className='col-8 text-start'>
                            <p><b>incl. 19% VAT. (the VAT of the respective EU country will be calculated at the checkout.) plus</b></p>
                        </div>
                        <div className='col-9'>
                            <p>{description}</p>
                        </div> 
                        ...
                        <Link className='t-hero-d' to='/Cart'>View purchase</Link>
                        <hr/>
                        <Link className='t-hero-d' to='/cervezas' >keep shopping</Link>
                        </div>)}
                        </div>
                    </div>
                </div>
